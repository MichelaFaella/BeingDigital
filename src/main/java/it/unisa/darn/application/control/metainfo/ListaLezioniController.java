...
import it.unisa.darn.application.service.metainfo.ListaLezioniService;
...
public class ListaLezioniController {
  ...
  @Autowired
  private ListaLezioniService listaLezioniService;
  ...
  public String get(Model model) {
    ...
    model.addAttribute("lezioniPerMetaInfo", listaLezioniService.getLezioniDaStudiare(utente));
